...
import ConfigUpdateCardsFromOtherDatabase from "@/components/ConfigUpdateCardsFromOtherDatabase";
  ...
  routes: [
...

    {
      ...
      children: [
        ...
        {
          path: "update-cards-from-other-database",
          name: "update-cards-from-other-database",
          component: ConfigUpdateCardsFromOtherDatabase,
        },
      ],
    },
  ],
